	...
	function openpost() {
		new daum.Postcode({
			oncomplete: function(data) {
				console.dir(data);
				document.getElementById("addrs").value = data.addrs;
							...
							<div class="row mb-5">
								<div class="col-12">
									...
									<tr>
										<th>PW :</th>
										<div>
										<td colspan="3"><input type="password" name="pwd" placeholder="비밀번호를 입력하세요"	size="50"/></td>
										</div>
									</tr>
									<tr>
										<th>NAME :</th>
									...
									<tr>
										<th>EMAIL : </th>
										<td>
										 <input type="text" name="email" placeholder="이메일을 입력하세요"> @ <input type="text" name="email_2">

                                 		 <select size="1" name="email_addr">
									...
									<tr>
										...
										<input type="submit"  class="btn btn-outline-white py-2 px-4"  value="  Join  " /> 
