...
public class CsController {
	...
	public String list(Model model, @RequestParam(name="currentPageNo",defaultValue="1")int currentPageNo,Principal pc,HttpSession session){
	...
	@PostMapping("/CsinsertForm")
		public String insert(@ModelAttribute CsDTO dto,HttpSession session,
				HttpServletRequest req,@ModelAttribute("uploadfile")UploadFile file) {
